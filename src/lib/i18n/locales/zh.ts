...
const zh: Messages = {
  ...
  "common.paste": "粘贴",
  "common.search": "搜索",
  "common.resize_hint": "拖拽调整大小 · 双击重置",
  "common.optional": "（可选）",
  "common.name": "名称",
  "common.color": "颜色",
  "common.import": "导入",
  ...
  "tab.context.split": "分屏",
  "tab.context.split.top": "上",
  "tab.context.split.bottom": "下",
  "tab.context.split.left": "左",
  "tab.context.split.right": "右",
  "terminal.pane.activate": "激活 {label}",
  "terminal.pane.close": "关闭窗格",
  "terminal.pane.resize": "调整窗格大小",
  "tab.context.copy": "复制",
  ...
  "sftp.edit.accept": "上传",
  "sftp.edit.large_file_warn": "{size} — 仍要打开？",
  "sftp.edit.deleted": "“{name}”的临时文件已被删除。",
  "sftp.edit.open_failed": "打开文件失败",
  "sftp.edit.upload_failed": "上传文件失败",
  ...
  "settings.shell.command_block_split": "命令块切分方式",
  "settings.shell.command_block_split_desc": "选择命令块边界来自确定的回车输入，还是启发式识别返回的 shell Prompt。",
  "settings.shell.command_block_split_enter": "回车",
  "settings.shell.command_block_split_enter_desc": "每次提交回车时切分。稳定、确定，适用于所有终端。",
  "settings.shell.command_block_split_prompt": "Prompt",
  "settings.shell.command_block_split_prompt_desc": "命令结束并识别到 shell Prompt 时切分。自定义 Prompt 可能漏识别，形似 Prompt 的输出可能误识别。",
  "settings.shell.command_block_split_new_sessions": "更改仅对新打开的终端生效，现有命令块不会被重写。",
  "settings.shell.command_block_split_error": "保存命令块切分方式失败：{error}",
  "settings.shell.command_block_max_lines": "最大输出行数",
  "settings.shell.command_block_max_lines_desc": "保留最新的输出行（{min}–{max}）。超限后自动折叠最早的行；可见行与缓存行之和严格小于 xterm 的 {scrollback} 行历史上限。",
  "settings.shell.command_block_max_lines_new_sessions": "更改仅对新打开的终端生效。",
  "settings.shell.command_block_max_lines_error": "保存命令块最大行数失败：{error}",
  ...
  "settings.shell.command_block_copy_redaction": "命令块复制脱敏",
  "settings.shell.command_block_prompt_redact": "Prompt 脱敏",
  "settings.shell.command_block_prompt_redact_desc": "识别每个命令块首行的 shell Prompt，并在复制为文本或图片时替换。",
  "settings.shell.command_block_prompt_replacement": "Prompt 替换为",
  "settings.shell.command_block_redact_hint": "复制命令块为文本或图片前，在本地按这些正则替换命令和输出。规则与 AI 脱敏规则相互独立。",
  "settings.shell.command_block_redact_new": "+ 新建",
  "settings.shell.command_block_redact_empty": "没有脱敏规则 — 复制命令块时只会按上方设置处理 Prompt。",
  "settings.shell.command_block_redact_pattern": "正则",
  "settings.shell.command_block_redact_replacement": "替换为",
  "settings.shell.command_block_redact_pattern_placeholder": "正则，如 AKIA[0-9A-Z]{16}",
  "settings.shell.command_block_redact_replacement_placeholder": "如 <REDACTED:aws-key>",
  "settings.shell.command_block_redact_delete": "删除",
  "settings.shell.command_block_redact_delete_confirm": "再点一次确认删除",
  "settings.shell.command_block_redact_cancel": "取消",
  "settings.shell.command_block_redact_error_empty": "正则 / 替换不能为空",
  "settings.shell.command_block_redact_error_load": "加载命令块复制脱敏设置失败：{error}",
  "settings.shell.command_block_redact_error_save": "保存命令块复制脱敏设置失败：{error}",
  "settings.shell.command_block_redact_error_delete": "删除命令块复制脱敏规则失败：{error}",
  ...
  "forward.rules": "转发规则",
  "forward.rule": "规则",
  "forward.rule_add": "+ 添加规则",
  "forward.rule_remove": "删除规则",
  "forward.rule_count": "{count} 条转发规则",
  "forward.via": "通过 {profile}",
  "forward.status_active": "运行中",
  "forward.status_error": "错误",
  "forward.status_stopped": "已停止",
  "forward.status_starting": "启动中",
  "forward.status_stopping_error": "停止失败",
  "forward.rule_toggle": "切换转发规则 {count}",
  "forward.start": "启动",
  "forward.stop": "停止",
  ...
  "ai.toolbar.new_session": "新开会话（当前对话归档）",
  "ai.toolbar.tokens_tip": "本会话累计 token：输入 {tin} / 输出 {tout}",
  ...
  "ai.audit.summary.user_message": "我：{content}",
  ...
  "ai.audit.summary.web_search_completed": "通过 {provider} 搜索网页: {query}（{size}，{dur}ms）",
  ...
  "ai.patch.tag": "补丁",
  "ai.patch.step.cp": "1/4 暂存复制",
  "ai.patch.step.modify": "2/4 修改",
  "ai.patch.step.diff": "3/4 审查差异",
  "ai.patch.step.mv": "4/4 应用",
  "ai.patch.file": "文件",
  "ai.patch.staging": "暂存",
  "ai.patch.find": "查找",
  "ai.patch.replace": "替换",
  ...
  "ai.settings.provider.hint": "Provider 由名称、协议类型、Endpoint（必填）、API Key 与模型组成；点左侧圆点设为当前。",
  "ai.settings.provider.new": "新建 Provider",
  "ai.settings.provider.empty": "尚未配置任何 Provider",
  "ai.settings.provider.activate": "设为当前 Provider",
  "ai.settings.provider.active": "使用中",
  "ai.settings.provider.delete_confirm": "再点一次确认删除",
  "ai.settings.provider.name_placeholder": "例如 DeepSeek / 我的 vLLM",
  "ai.settings.provider.protocol": "协议类型",
  "ai.settings.protocol.sub.deepseek": "reasoning_content 回传",
  "ai.settings.protocol.sub.openai": "OpenAI / GLM / vLLM …",
  "ai.settings.protocol.sub.anthropic": "Claude 官方协议",
  "ai.settings.provider.error.name_required": "名称不能为空",
  "ai.settings.provider.error.endpoint_required": "Endpoint 不能为空",
  "ai.settings.provider.error.model_required": "模型不能为空（可拉取列表或直接填写）",
  "ai.settings.note.providers_failed": "加载 Provider 列表失败: {error}",
  "ai.settings.note.delete_failed": "删除失败: {error}",
  ...
  "ai.settings.danger.auto.web_search": "web_search（查询出网前已脱敏）",
  "ai.settings.danger.auto.web_fetch": "web_fetch（自动抓取任意 URL — 无主机限制）",
  ...
  "error.fwd_rules_empty": "请至少添加一条转发规则",
  "error.fwd_duplicate_remote_port": "远端端口 {port} 被多条规则重复使用",
  "error.fwd_duplicate_listen_port": "监听端口 {port} 被多条规则重复使用",
  "error.fwd_invalid_port": "转发目标端口必须在 1 到 65535 之间",
  "error.fwd_remote_host_empty": "本地和远程转发必须填写远端主机",
  "error.fwd_rule_stopped_unexpectedly": "转发规则意外停止",
  "error.fwd_session_closed": "转发会话已关闭",
  ...
  "error.sftp_edit_open_failed": "打开文件失败：{err}",
  "error.sftp_edit_read_failed": "读取临时文件失败：{err}",
  "error.sftp_edit_not_found": "编辑会话不存在",
  ...
  "error.webdav_api_error": "WebDAV 错误：{op} → {status} {msg}",
  "error.webdav_password_missing": "未配置 WebDAV 密码",
  "error.webdav_auth_failed": "WebDAV 认证失败（{op}，{status}）",
  ...
  "error.webdav_preflight_failed": "WebDAV 预检失败：{err}",
  ...
  "sync.categories.command_block_redact": "命令块复制脱敏规则",
