...
const en = {
  ...
  "tab.context.split": "Split Pane",
  "tab.context.split.top": "Up",
  "tab.context.split.bottom": "Down",
  "tab.context.split.left": "Left",
  "tab.context.split.right": "Right",
  "terminal.pane.activate": "Activate {label}",
  "terminal.pane.close": "Close pane",
  "terminal.pane.resize": "Resize panes",
  ...
  "sftp.edit.large_file_warn": "{size} — open anyway?",
  "sftp.edit.deleted": "Temp file for \"{name}\" was deleted.",
  "sftp.edit.open_failed": "Failed to open file",
  "sftp.edit.upload_failed": "Failed to upload file",
  ...
  "settings.shell.command_block_split": "BLOCK BOUNDARY",
  "settings.shell.command_block_split_desc": "Choose whether command-block boundaries come from deterministic Enter input or heuristic shell-prompt recognition.",
  "settings.shell.command_block_split_enter": "ENTER",
  "settings.shell.command_block_split_enter_desc": "Split whenever Enter is submitted. Stable and deterministic in every terminal.",
  "settings.shell.command_block_split_prompt": "PROMPT",
  "settings.shell.command_block_split_prompt_desc": "Split when a command finishes and a shell prompt is recognized. Custom prompts may be missed; prompt-like output may be mistaken for one.",
  "settings.shell.command_block_split_new_sessions": "Changes apply to newly opened terminals; existing command blocks are not rewritten.",
  "settings.shell.command_block_split_error": "Failed to save the command-block boundary: {error}",
  "settings.shell.command_block_max_lines": "MAXIMUM OUTPUT LINES",
  "settings.shell.command_block_max_lines_desc": "Keep the newest output rows visible ({min}–{max}). Older rows fold automatically; visible and cached rows stay below xterm's {scrollback}-row history limit.",
  "settings.shell.command_block_max_lines_new_sessions": "Changes apply to newly opened terminals.",
  "settings.shell.command_block_max_lines_error": "Failed to save the command-block line limit: {error}",
  ...
  "settings.shell.command_block_copy_redaction": "COMMAND-BLOCK COPY REDACTION",
  "settings.shell.command_block_prompt_redact": "REDACT PROMPT",
  "settings.shell.command_block_prompt_redact_desc": "Recognize the shell prompt on each command block's first row and replace it when copying as text or image.",
  "settings.shell.command_block_prompt_replacement": "REPLACE PROMPT WITH",
  "settings.shell.command_block_redact_hint": "Applied locally to commands and output before copying command blocks as text or image. These rules are independent from AI redaction rules.",
  "settings.shell.command_block_redact_new": "+ New",
  "settings.shell.command_block_redact_empty": "No redaction rules — copied command blocks will only apply the prompt setting above.",
  "settings.shell.command_block_redact_pattern": "PATTERN",
  "settings.shell.command_block_redact_replacement": "REPLACE WITH",
  "settings.shell.command_block_redact_pattern_placeholder": "regex, e.g. AKIA[0-9A-Z]{16}",
  "settings.shell.command_block_redact_replacement_placeholder": "e.g. <REDACTED:aws-key>",
  "settings.shell.command_block_redact_delete": "Delete",
  "settings.shell.command_block_redact_delete_confirm": "Click again to confirm",
  "settings.shell.command_block_redact_cancel": "Cancel",
  "settings.shell.command_block_redact_error_empty": "pattern / replacement cannot be empty",
  "settings.shell.command_block_redact_error_load": "Failed to load command-block copy redaction settings: {error}",
  "settings.shell.command_block_redact_error_save": "Failed to save command-block copy redaction settings: {error}",
  "settings.shell.command_block_redact_error_delete": "Failed to delete command-block copy redaction rule: {error}",
  ...
  "forward.rules": "Forwarding Rules",
  "forward.rule": "Rule",
  "forward.rule_add": "+ Add Rule",
  "forward.rule_remove": "Remove rule",
  "forward.rule_count": "{count} forwarding rule(s)",
  "forward.via": "via {profile}",
  "forward.status_active": "Active",
  "forward.status_error": "Error",
  "forward.status_stopped": "Stopped",
  "forward.status_starting": "Starting",
  "forward.status_stopping_error": "Stop failed",
  "forward.rule_toggle": "Toggle forwarding rule {count}",
  "forward.start": "Start",
  "forward.stop": "Stop",
  ...
  "ai.toolbar.new_session": "New session (archives current chat)",
  "ai.toolbar.tokens_tip": "Session tokens: {tin} in / {tout} out",
  ...
  "ai.toolbar.reasoning_show": "Show reasoning",
  "ai.toolbar.reasoning_hide": "Hide reasoning",
  ...
  "ai.error.no_provider": "Create and activate a provider in Settings → AI Diagnose first",
  ...
  "ai.webcmd.fetch": "Web fetch",
  "ai.webcmd.allow": "Allow",
  "ai.webcmd.reject": "Reject",
  ...
  "ai.audit.summary.user_message": "You: {content}",
  ...
  "ai.audit.summary.web_search_completed": "Searched web via {provider}: {query} ({size}, {dur}ms)",
  ...
  "ai.patch.tag": "Patch",
  "ai.patch.step.cp": "1/4 stage copy",
  "ai.patch.step.modify": "2/4 modify",
  "ai.patch.step.diff": "3/4 review diff",
  "ai.patch.step.mv": "4/4 apply",
  "ai.patch.file": "File",
  "ai.patch.staging": "Staging",
  "ai.patch.find": "Find",
  ...
  "ai.settings.provider.hint": "A provider is a name, a protocol type, an endpoint (required), an API key and a model. Click the dot to make it active.",
  "ai.settings.provider.new": "New Provider",
  "ai.settings.provider.empty": "No provider configured yet",
  "ai.settings.provider.activate": "Set as active provider",
  "ai.settings.provider.active": "Active",
  "ai.settings.provider.delete_confirm": "Click again to confirm",
  "ai.settings.provider.name_placeholder": "e.g. DeepSeek / My vLLM",
  "ai.settings.provider.protocol": "Protocol",
  "ai.settings.protocol.sub.deepseek": "reasoning_content echo",
  "ai.settings.protocol.sub.openai": "OpenAI / GLM / vLLM …",
  "ai.settings.protocol.sub.anthropic": "Claude native protocol",
  "ai.settings.provider.error.name_required": "Name is required",
  "ai.settings.provider.error.endpoint_required": "Endpoint is required",
  "ai.settings.provider.error.model_required": "Model is required (load the list or type one)",
  "ai.settings.note.providers_failed": "Failed to load providers: {error}",
  "ai.settings.note.delete_failed": "Delete failed: {error}",
  ...
  "error.fwd_rules_empty": "Add at least one forwarding rule",
  "error.fwd_duplicate_remote_port": "Remote port {port} is used by more than one rule",
  "error.fwd_duplicate_listen_port": "Listen port {port} is used by more than one rule",
  "error.fwd_invalid_port": "Forwarding target ports must be between 1 and 65535",
  "error.fwd_remote_host_empty": "Remote host is required for local and remote forwarding",
  "error.fwd_rule_stopped_unexpectedly": "The forwarding rule stopped unexpectedly",
  "error.fwd_session_closed": "Forwarding session is closed",
  ...
  "error.sftp_edit_open_failed": "Failed to open file: {err}",
  "error.sftp_edit_read_failed": "Failed to read temp file: {err}",
  "error.sftp_edit_not_found": "Edit session not found",
  ...
  "error.webdav_api_error": "WebDAV error: {op} → {status} {msg}",
  "error.webdav_password_missing": "WebDAV password not configured",
  "error.webdav_auth_failed": "WebDAV authentication failed ({op}, {status})",
  ...
  "error.webdav_preflight_failed": "WebDAV pre-flight failed: {err}",
  ...
  "sync.categories.command_block_redact": "Command-block copy redaction rules",
